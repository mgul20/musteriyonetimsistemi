...
<c:forEach var="user" items="${listUser}">
                                ...
                                <tr>
                                    <td>
                                        <c:out value="${user.turu}" />
                                    </td>
                                    <td>
                                        <c:out value="${user.name}" />
                                    </td>
                                    <td>
                                        <c:out value="${user.tamadi}" />
                                    </td>
                                    <td>
                        ...
                        <td>
                            ...
                            <a href="edit?id=<c:out value='${user.id}' />" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="delete?id=<c:out value='${user.id}' />" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
