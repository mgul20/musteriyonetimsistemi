...
<%-- arabölümilk--%>                                                        
               <div class="col-lg-9 mb-4">
                ...
                <div class="card-body">
                        ...
                        <input type="text" class="search form-control" placeholder="Müşteri Ara...">
                        </div>
                    <table class="table table-striped table-hover card-text table-bordered results">
                      <thead>
                       <tr>
                                <th>ID</th>
                                <th>Kodu</th>
...
<c:forEach var="musteri" items="${listMusteri}">
                                ...
                                <tr>
                                    <td>
                                        <c:out value="${musteri.id}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.kodu}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.adi}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.yetkiliadi}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.turu}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.email}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.gsm}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.tel}" />
                                    </td>
                                    <%--                               <td>
                                        <c:out value="${musteri.ulke}" />
                                    </td>
                                    <td>
                                        <c:out value="${musteri.sehir}" />
                                    </td>
                                     <td>
                                        <c:out value="${musteri.adres}" />
                                    </td>  --%>                               

                                    
                        <td>
                            <a href="musdetay?id=<c:out value='${musteri.id}' />" class="view" title="Detay" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <a href="editmus?id=<c:out value='${musteri.id}' />" class="edit" title="Düzelt" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="deletemus?id=<c:out value='${musteri.id}' />" class="delete" title="Sil" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                            <a href="kontakmus?id=<c:out value='${musteri.id}' />" class="kontak" title="Kontak Ekle" data-toggle="tooltip"><i class="material-icons">&#xE253</i></a>
                        </td>                                
                                </tr>
                            </c:forEach>
                      </tbody>
