                ...
                <div class="card-header">
                  ...
                  <div class="card-body">                           
                    <table class="table table-striped table-hover card-text">
                      ...
                      <tbody>
                            <c:forEach var="kontak" items="${listKontak}">

                                <tr>
                                    <td>
                                        <c:out value="${kontak.id}" />
                                    </td>
                                    <td>
                                        <c:out value="${kontak.musteri_id}" />
                                    </td>
                                    <td>
                        ...
                        <td>
                            ...
                            <a href="editkontak?id=<c:out value='${kontak.id}' />" class="edit" title="Düzelt" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="deletekontak?id=<c:out value='${kontak.id}' />" class="delete" title="Sil" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
